"""
DSGVO Voice Assistant - LiveKit Agent (merged)
- Telefonie & SIP: wartet auf eingehenden Teilnehmer (ctx.wait_for_participant) und nutzt den vom SIP-Ingress erstellten Raum
- DSGVO-Logik/Persona/Tools: erhalten & erweitert
- Azure OpenAI (Chat + Embeddings), Azure Speech (STT/TTS), Silero VAD
- Pinecone aktiv
- Mehrsprachig möglich, Standard: Deutsch
- NEU: warmer Transfer (SDK), Timeout 25s -> WhatsApp + Info an Anrufer
"""
